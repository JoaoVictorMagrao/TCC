...
function Fichas() {
  ...
  useEffect(() => {
    ...
    fetchDataStudens(idTeacher, setLoading, setSheet);
    ...
    <div>
      ...
      <Dialog open={openModalPrinter} onClose={handleClickCloseModalPrinter}>
        ...
        <DialogActions>
          ...
          <Button onClick={() => printTrainingSheets(selectedDateStartPrint, selectedDateEndPrint, selectedIdStudent, toast, idTeacher, fichasPDF, setSheet, setLoading)}>Imprimir</Button>
        </DialogActions>
      </Dialog>
